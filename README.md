...
- **Full automation.** The workflow from ethanol topology input to final
...
└── output             # Pipeline results (omitted from the repo) 
```
...
- Apply the pipeline to a different small molecule.
